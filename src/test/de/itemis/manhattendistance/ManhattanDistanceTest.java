...
public class ManhattanDistanceTest {
    ...
    static Stream<Arguments> objectArguments() {
        return Stream.of(
                Arguments.of(new Point(1, 1), new Point(2, 2), 2),
                Arguments.of(new Point(2, 2), new Point(5, 7), 8)
        );
    }
    ...
    @MethodSource("intArguments")
    void checkDistanceCalcForTwoPoints(int x1, int y1, int x2, int y2, int expected) {
    ...
    @MethodSource("objectArguments")
    void checkDistanceCalcForTwoPoints(Point p1, Point p2, int expected) {
        ManhattanDistance manhattanDistance = new ManhattanDistance();
